...
public class Mini 
{
	...
	private void loadClues()
	{
		try 
		{
			Scanner sc3 = new Scanner(new File("src/wordlists/3sorted.game"));
			Scanner sc4 = new Scanner(new File("src/wordlists/4sorted.game"));
			Scanner sc5 = new Scanner(new File("src/wordlists/5sorted.game"));
